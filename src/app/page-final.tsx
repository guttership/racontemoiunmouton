        ...
        <div className="relative max-w-5xl mx-auto p-4 z-10">
          ...
          <div className="bg-white  rounded-3xl p-8  border border-gray-100 mb-8">
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-3xl lg:text-4xl font-courgette text-gray-900">
                    Votre histoire magique
                  </h1>
                  <p className="text-gray-600 mt-1 font-clash-grotesk">
              ...
              <Button
                ...
                className="bg-white hover:bg-white border-2 border-gray-200 hover:border-orange-300 text-gray-800 px-6 py-3 rounded-2xl font-clash-grotesk font-semibold transition-all duration-200 "
              >
          ...
          <div className="bg-white  rounded-3xl p-8  border border-gray-100 mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-2xl font-courgette text-gray-900">
                Écouter l&apos;histoire
              </h2>
            </div>
          ...
          <div className="bg-white  rounded-3xl p-8  border border-gray-100">
            <div className="prose max-w-none text-lg leading-relaxed text-gray-800 font-clash-grotesk">
              {generatedStory.split('\n').map((paragraph, index) => (
                paragraph.trim() && (
                  <p key={index} className="mb-6 first:mb-4 last:mb-0 text-justify font-clash-grotesk">
                    {paragraph}
                  </p>
                )
              ))}
    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <header className="relative text-center py-16 px-4 z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-courgette text-gray-900 mb-6 leading-tight">
            Raconte-moi un mouton
          </h1>
          <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto font-clash-grotesk">
      ...
      <main className="relative max-w-7xl mx-auto px-4 pb-20 z-10">
        ...
        <div className="mt-12 text-center">
          <div className="bg-white  rounded-3xl p-8  border border-gray-100 max-w-2xl mx-auto">
            <Button
              ...
              className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-12 py-6 rounded-2xl text-xl font-clash-grotesk font-bold   transition-all duration-200 border-2  w-full"
            >
              {isGenerating ? (
                <>
            ...
            {!canGenerateStory && (
              <div className="mt-6">
                <p className="text-gray-600 bg-white border border-gray-200 rounded-2xl p-4 text-center font-clash-grotesk">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white  rounded-2xl p-6  border border-gray-100 text-center">
            ...
            <h3 className="font-courgette text-xl text-gray-900 mb-2">Choisir les héros</h3>
            <p className="text-gray-600 text-sm font-clash-grotesk">Sélectionnez les personnages de l&apos;aventure</p>
          </div>
          
          <div className="bg-white  rounded-2xl p-6  border border-gray-100 text-center">
            <EnvironmentIcon className="w-16 h-16 mx-auto mb-4" />
            <h3 className="font-courgette text-xl text-gray-900 mb-2">Définir le décor</h3>
            <p className="text-gray-600 text-sm font-clash-grotesk">Où se déroule cette histoire ?</p>
          </div>
          
          <div className="bg-white  rounded-2xl p-6  border border-gray-100 text-center">
            <ChildIcon className="w-16 h-16 mx-auto mb-4" />
            <h3 className="font-courgette text-xl text-gray-900 mb-2">Adapter à l&apos;âge</h3>
            <p className="text-gray-600 text-sm font-clash-grotesk">Pour une histoire parfaite</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-100 to-orange-50  rounded-2xl p-6  border border-gray-200 text-center">
            ...
            <h3 className="font-courgette text-xl text-gray-900 mb-2">Magie en action</h3>
            <p className="text-gray-600 text-sm font-clash-grotesk">L&apos;IA crée votre histoire unique</p>
          </div>
        </div>
      </main>
    </div>
